...
public class Lanceur {
        ...
        private static final Logger logger = LogManager.getLogger("Messages de log");


    public static void main(String[] args) {

        DBService.recupererLAdresseBase("192.168.1.21:3306");
        ...
        while (true) {
            ...
            try {
                ...
                if (command.equals("0")) {
                    ...
                    logger.info("Je regarde les clients!");
                    listerProduit();
