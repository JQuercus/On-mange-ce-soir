...
public class DBService {
    ...
    private static String adresse_base;


    public static void recupererLAdresseBase(String adresse){
    ...
    private DBService() {
        try {
            ...
            connection = DriverManager.getConnection(
                    "jdbc:mysql://" + adresse_base + "/ecommerce?user=root&password=formation&useSSL=false");
